...
const pDisplay = document.getElementById('EstacaoImg')
...
const estacoes = {
  verao: {
    nomeEstacao: 'Verão',
    fotoEstacao: './verao.webp',
  },
  outono: {
    nomeEstacao: 'Outono',
    fotoEstacao: './outono.jpg',
  },
  inverno: {
    nomeEstacao: 'Inverno',
    fotoEstacao: './inverno.webp',
  },
  primavera: {
    nomeEstacao: 'Primavera',
    fotoEstacao: './primavera.jpg',
  },
}
...
function verificaEstacao() {
    ...
    // exibe na tela
    pDisplay.innerHTML = `${estacao.nomeEstacao}.`
  
    // cria um elemento de imagem
    const img = document.createElement('img')
    // define o src do icone e o alt
    img.src = `${estacao.fotoEstacao}`
    img.alt = estacao.nomeEstacao
